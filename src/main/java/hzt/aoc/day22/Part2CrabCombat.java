...
public class Part2CrabCombat extends Day22Challenge {
    ...
    private int playRecursiveGame(Deque<Integer> player1Cards, Deque<Integer> player2Cards) {
        ...
        while (!player1Cards.isEmpty() && !player2Cards.isEmpty()) {
            ...
            if (configsPlayer1.contains(curConfigurationPlayer1) || configsPlayer2.contains(curConfigurationPlayer2)) {
                return 1;
            }
            configsPlayer1.add(curConfigurationPlayer1);
            configsPlayer2.add(curConfigurationPlayer2);
